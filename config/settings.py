...
STRAVA_WEBHOOK_PROCESSING_ENABLED = os.getenv("STRAVA_WEBHOOK_PROCESSING_ENABLED", "False").lower() == "true"
STRAVA_WEBHOOK_BATCH_SIZE = max(1, min(int(os.getenv("STRAVA_WEBHOOK_BATCH_SIZE", "50")), 500))
STRAVA_WEBHOOK_MAX_ATTEMPTS = max(1, min(int(os.getenv("STRAVA_WEBHOOK_MAX_ATTEMPTS", "5")), 20))
STRAVA_WEBHOOK_RETRY_BASE_SECONDS = max(5, int(os.getenv("STRAVA_WEBHOOK_RETRY_BASE_SECONDS", "30")))
STRAVA_WEBHOOK_RETRY_MAX_SECONDS = max(
    STRAVA_WEBHOOK_RETRY_BASE_SECONDS,
    int(os.getenv("STRAVA_WEBHOOK_RETRY_MAX_SECONDS", "3600")),
)
STRAVA_WEBHOOK_STALE_AFTER_SECONDS = max(60, int(os.getenv("STRAVA_WEBHOOK_STALE_AFTER_SECONDS", "900")))
STRAVA_WEBHOOK_POLL_SECONDS = max(0.5, min(float(os.getenv("STRAVA_WEBHOOK_POLL_SECONDS", "5")), 60))
STRAVA_WEBHOOK_RETENTION_DAYS = max(7, int(os.getenv("STRAVA_WEBHOOK_RETENTION_DAYS", "30")))
