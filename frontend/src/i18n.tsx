...
const en = {
  ...
  connectAthleteFirst: "Connect an athlete to your team before creating a training plan.",
  ...
  roster: "ROSTER",
  yourAthletes: "Your team",
  team: "TEAM",
  teamReady: "Your coaching team",
  teamDescription: "All athletes currently connected to your coaching workspace.",
...
const ru: Dictionary = {
  ...
  connectAthleteFirst: "Подключите спортсмена к команде, прежде чем создавать тренировочный план.",
  ...
  roster: "КОМАНДА",
  yourAthletes: "Ваша команда",
  team: "КОМАНДА",
  teamReady: "Ваша тренерская команда",
  teamDescription: "Все спортсмены, подключённые к вашему тренерскому пространству.",
  activeAthletes: "активных спортсменов",
