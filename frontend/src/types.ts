...
export interface TrainingPlan { id: number; coach: number; title: string; description: string; primary_sport: string; target_event_name: string; target_event_type: string; target_distance_km: string | null; athlete: number; start_date: string; end_date: string; is_active: boolean; weeks: WeeklyPlan[] }
